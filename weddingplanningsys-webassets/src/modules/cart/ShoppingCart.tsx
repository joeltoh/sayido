...
export default class ShoppingCart extends Component<ShoppingCartProps, ShoppingCartState> {
  ...
  getOrderTotal = async () => {
    ...
    let total = ordersInCart.reduce((total: number, service: Order) => {
    ...
    return (
      ...
      <div className="Category">
        ...
        <div className="well-bs padding-bottom-120">
          ...
          {this.state.orders.map(order => <CartProductRow order={order} key={order.serviceId} calculateTotal={() => this.getOrderTotal()} />)}
